...
<body>
  ...
  <section id="loveStory" class="text-center d-flex justify-content-center align-items-center flex-column">
    ...
    <div class="event text-center" onclick="flipPage(this)">
      <div class="scrapbook-page" onclick="flipPage(this)">
        ...
        <div class="back">
          <p>What about the first time we kissed? Still remember? Those sneaky moments we did were so memorable to me that I would never forget. I love you so much baby ❤️</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="imageSliderTwo">
    ...
    <h2 id="surpriseMessage" style="color:#f28d85; display: none;">Surprised? 😂</h2>
  ...
  <footer>
    <p style="color:#ffffff;">❤️ Since April 24, 2024 ❤️</p>
  </footer>
